...
namespace LuaDLLTest
{
	...
	static class NativeMethods
	{
		...
		internal static extern double LuaToNumber (IntPtr luaState, int index, int num);
		...
		internal static extern int LuaLLoadBuffer (IntPtr luaState, string buff, uint size, string name);
		...
		internal static extern void LuaGetGlobal (IntPtr luaState, string name);
